    ...
    return (
        <div>
            <div>
                ...
                <div className='mt-12 flex justify-center items-center gap-32 mb-32'>
                    ...
                    <button className='border-b-2 border-[#fa4c4c] rounded-xl px-5 hover:bg-[#fa4c4c] hover:text-white py-1 font hover:rounded-full cursor-pointer'>raphics Design</button>
